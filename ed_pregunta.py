...
def manipula_preguntas(datos):
    ...
    def recupera_preg(ide):
     ...
     for preg in pregs:
        tabl_pre.insert(parents="",index="end",iid=preg[0],text=str(preg[0]),
        values=(preg[1],preg[2],preg[3],preg[4],preg[5],preg[6]))
    ...
    cate = Entry(pantalla_pre, textvariable=str_cat, font='Helvetica 14 bold ', bg="Lavender", width=50,).place(x=20, y=700)

    et2=Label(pantalla_pre, textvariable=str_pre,text="pregunta",bg="Light Sky Blue",font='Helvetica 14 bold ').place(x=20, y=60)
    preg = Entry(pantalla_pre, textvariable=str_pre, font='Helvetica 14 bold ',bg="Lavender", width=80).place(x=120, y=60)
     
    et3=Label(pantalla_pre,text="Opcion 1",bg="Ligth Sky Blue", font='Helvetica 14 bold ').place(x=20, y=90)
    op1 = Entry(pantalla_pre, textvariable=str_op1, font='Helvetica 14 bold ',bg="Lavender", width=30).place(x=120, y=90)

    et4=Label(pantalla_pre,text="Opcion 2",bg="Light Sky Blue", font='Helvetica 14 bold ').place(x=550, y=90)
    op2 = Entry(pantalla_pre, textvariable=str_op2, font='Helvetica 14 bold ',bg="lavender", width=30).place(x=670, y=90)

    et5=Label(pantalla_pre,text="Opcion 3",bg="Light Sky Blue", font='Helvetica 14 bold ').place(x=20, y=120)
    op3 =Entry(pantalla_pre, textvariable=str_op3, font='Helvetica 14 bold ',bg="lavender", width=30).place(x=120, y=120)

    et6=Label(pantalla_pre,text="Opcion 4",bg="Light Sky Blue", font='Helvetica 14 bold ').place(x=550, y=120)
    op4 = Entry(pantalla_pre, textvariable=str_op4, font='Helvetica 14 bold ',bg="lavender", width=30).place(x=120, y=150)
    ...
    b_per = Button(pantalla_pre, text="Agregar Pregunta",command=agrega_pre,fg="White",bg="red4", font='Arial 12').place(x=1,y=0)
    b_modif_pre=Button(pantalla_pre,text="Modifica Pregunta",command=modif_pre,fg="white",bg="red4",font="Arial 12",width=20).place(x=180,y=0)
    b_borra_pre=Button(pantalla_pre,text="Borrar Pregunta",command=borra_pre,fg="white",bg="red4",font="Arial 12",width=20).place(x=390,y=0)
    b_select_pre=Button(pantalla_pre,text="Selecciona Pregunta",command=selec_pre,fg="white",bg="red4",font="Arial 12",width=20).place(x=600,y=0)
